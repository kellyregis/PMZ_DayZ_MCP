class ActionCraftImprovisedFaceCoverCB : ActionContinuousBaseCB
{
...
class ActionCraftImprovisedFaceCover: ActionContinuousBase
{
	void ActionCraftImprovisedFaceCover()
	{
		m_CallbackClass = ActionCraftImprovisedFaceCoverCB;
		m_CommandUID = DayZPlayerConstants.CMD_ACTIONFB_CRAFTING;
		m_FullBody = true;
		m_StanceMask = DayZPlayerConstants.STANCEMASK_CROUCH;
		m_SpecialtyWeight = UASoftSkillsWeight.ROUGH_HIGH;
		m_Text = "#STR_CraftImprovisedFaceCover";
	}
	...
	override void OnFinishProgressServer( ActionData action_data )
	{
		...
		EntityAI cover = action_data.m_Player.SpawnEntityOnGroundRaycastDispersed("FaceCover_Improvised");
