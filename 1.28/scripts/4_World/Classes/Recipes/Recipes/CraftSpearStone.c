class CraftSpearStone extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_CraftSpear0";
		...
		m_MaxDamageIngredient[0] = 3;//-1 = disable che
		...
		//result1
		AddResult("SpearStone");//add results here
	...
	{
		ItemBase stick = ingredients[1];
		
		if(stick.GetInventory().AttachmentCount() == 0)
		{
			return true;
		}
		return false;
