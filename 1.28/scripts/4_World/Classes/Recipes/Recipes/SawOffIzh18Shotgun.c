...
{	
	...
	override bool CanDo(ItemBase ingredients[], PlayerBase player)
	{
		...
		if ( ingredient1.GetType() == "SawedoffIzh18Shotgun" )
		{
			return false;			
		}
		else if ( ingredient1.GetType() == "Izh18Shotgun" )
		{
			return true;
		}
		else
	...
	{
		MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[0], "SawedoffIzh18Shotgun", player));
	}
};
