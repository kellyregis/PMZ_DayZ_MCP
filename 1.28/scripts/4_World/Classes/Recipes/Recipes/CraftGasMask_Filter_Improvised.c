class CraftGasMask_Filter_Improvised extends RecipeBase	
{	
	override void Init()
	{
		m_Name = "#STR_CraftImprovisedFilter";
		...
		//ingredient 2
		InsertIngredient(1,"NioshFaceMask");//you can insert multiple ingredients this way
