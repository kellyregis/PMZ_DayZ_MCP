class PaintGhillieSuitGreenMossy extends RecipeBase
{
	...
	{
		//PaintItem.Paint(ingredients[0], ingredients[1], "B95", player, specialty_weight);
		MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[1], "GhillieSuit_Woodland", player));
	}
};
