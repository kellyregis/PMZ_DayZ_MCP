class CraftDrysackBag: RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_CraftDrysackBag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"WaterproofBag_ColorBase");	//you can insert multiple ingredients this way
		...
		//RESULTS
		//result1
		AddResult("DrysackBag_");						// add results here
