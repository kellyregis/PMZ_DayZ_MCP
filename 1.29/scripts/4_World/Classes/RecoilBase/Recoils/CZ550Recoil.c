class CZ550Recoil: RecoilBase
{
	override void Init()
	{
		...
		m_HandsOffsetRelativeTime = 0.425;
		
		m_MouseOffsetRangeMin = 80;//in degrees min
		m_MouseOffsetRangeMax = 160;//in degrees max
		m_MouseOffsetDistance = 2.25;//how far should the mouse travel
