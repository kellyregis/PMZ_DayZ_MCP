class ChelateWater extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_PurifyWaterWithChelation0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ChelatingTablets");//you can insert multiple ingredients this way
