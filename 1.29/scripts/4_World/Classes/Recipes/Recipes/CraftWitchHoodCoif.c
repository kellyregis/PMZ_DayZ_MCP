class CraftWitchHoodCoif: RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_CraftArmoredHood";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"WitchHood_ColorBase");			//you can insert multiple ingredients this way
		...
		//ingredient 2	
		InsertIngredient(1,"Chainmail_Coif");
		...
		//RESULTS		
		//result1
		AddResult("WitchHoodCoif_");					// add results here
