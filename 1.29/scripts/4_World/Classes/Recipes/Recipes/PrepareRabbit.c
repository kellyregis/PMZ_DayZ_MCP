class PrepareRabbit extends PrepareAnimal
{	
	override void Init()
	{
		super.Init();
		...
		//----------------------------------------------------------------------------------------------------------------------
		//ingredient 1
		InsertIngredient(0,"DeadRabbit", DayZPlayerConstants.CMD_ACTIONFB_ANIMALSKINNING, false);		//you can insert multiple ingredients this way
